...
similar_to_independence = all_prez_embeddings.most_similar("independence", topn=20)
print(similar_to_independence)
...
# view words similar to strength for presidents
rushmore_similar_to_strength = rushmore_embeddings.most_similar("strength", topn=20)
print(rushmore_similar_to_strength)
